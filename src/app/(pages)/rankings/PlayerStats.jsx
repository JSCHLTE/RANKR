    ...
    <>
        ...
        { pos === "QB" ? 
          ...
          <>
            ...
            <th colSpan={5} className='table-section'>Rushing</th>
          </tr>
          <tr>
          <th>{labels.team.label}</th>
            <th>{labels.year.label}</th>
    ...
    return (
      <>
          ...
          <>
            ...
            <td><div className={getStat(item.totals?.fantasyPoints, seasonTotals.WR.fantasyPoints.low, seasonTotals.WR.fantasyPoints.mid)}>{
          ...
          { player.position === "TE" ? 
            ...
            <td><div className={getStatLow(item.totals?.seasonalRank, seasonTotals.RANK.TE.low, seasonTotals.RANK.TE.mid)}>{item.totals?.seasonalRank ?? 0}</div></td>
            <td className='border-right'><div className='table-stat'>{(item.totals?.snapPct * 100).toFixed(2)}</div></td>
          ...
          { player.position === "QB" ? 
            ...
            <td className='border-right'><div className={getStatLow(item.totals?.seasonalRank, seasonTotals.RANK.QB.low, seasonTotals.RANK.QB.mid)}>{item.totals?.seasonalRank ?? 0}</div></td>
